      ...
      <div className="footer-container">
        ...
        <div className="footer-cards">
          ...
          <div className="footer-card">
            ...
            <p className="footer-card-subtext">Consultas presenciales y online</p>
          </div>
          ...
          <div className="footer-card">
            ...
            <p className="footer-card-subtext">Respuesta en 24 horas</p>
          </div>
          ...
          <div className="footer-card">
            ...
            <p className="footer-card-subtext">WhatsApp disponible</p>
          </div>
          ...
          <div className="footer-card">
            ...
            <p className="footer-card-subtext">Sabados con cita previa</p>
          </div>
        </div>
