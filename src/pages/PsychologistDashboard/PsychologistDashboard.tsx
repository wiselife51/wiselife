...
const PsychologistDashboard: React.FC = () => {
  ...
  <div className="psy-dash-sidebar-header psy-appt-sidebar-header">
  <div className="psy-dash-brand">
  <div className="psy-dash-logo">
  ...
  <div className="psy-dash-badge">Detalle de la Cita</div>
  </div>
  ...
  {/* Patient section */}
  <div className="psy-dash-profile psy-appt-patient-profile">
  ...
  <p className="psy-dash-email">{selectedAppt.patient?.email || 'Correo no registrado'}</p>
              ...
              <div className="psy-appt-details">
                ...
                <div className="psy-dash-nav-item psy-appt-detail-row">
                  ...
                  <span className={`psy-dash-nav-badge ${selectedAppt.payment_status === 'procesando' ? 'psy-dash-nav-badge--warning' : ''}`}>
                ...
                <div className="psy-dash-nav-item psy-appt-detail-row">
                  ...
                  <span>Estado: </span>
                  <span className={`psy-dash-nav-badge ${selectedAppt.status !== 'confirmada' ? 'psy-dash-nav-badge--warning' : ''}`}>
